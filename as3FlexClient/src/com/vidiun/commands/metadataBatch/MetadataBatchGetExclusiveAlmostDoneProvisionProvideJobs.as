package com.vidiun.commands.metadataBatch
{
	...
	import com.vidiun.delegates.metadataBatch.MetadataBatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate;
	import com.vidiun.net.VidiunCall;

	public class MetadataBatchGetExclusiveAlmostDoneProvisionProvideJobs extends VidiunCall
	{
		public var filterFields : String;
		public function MetadataBatchGetExclusiveAlmostDoneProvisionProvideJobs( lockKey : VidiunExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : VidiunBatchJobFilter=null )
		{
