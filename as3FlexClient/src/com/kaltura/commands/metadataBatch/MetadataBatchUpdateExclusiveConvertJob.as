package com.vidiun.commands.metadataBatch
{
	...
	import com.vidiun.delegates.metadataBatch.MetadataBatchUpdateExclusiveConvertJobDelegate;
	import com.vidiun.net.VidiunCall;

	public class MetadataBatchUpdateExclusiveConvertJob extends VidiunCall
	{
		public var filterFields : String;
		public function MetadataBatchUpdateExclusiveConvertJob( id : int,lockKey : VidiunExclusiveLockKey,job : VidiunBatchJob,entryStatus : int=undefined )
		{
